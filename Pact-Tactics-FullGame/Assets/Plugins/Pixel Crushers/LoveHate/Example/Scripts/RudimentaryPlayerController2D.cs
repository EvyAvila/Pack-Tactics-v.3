...
namespace PixelCrushers.LoveHate.Example
{
	...
	public class RudimentaryPlayerController2D : Mover2D
	{
		...
		protected override void Start ()
		{
			...
			interactionUI = PixelCrushers.GameObjectUtility.FindFirstObjectByType<InteractionUI>();
		...
		{
			var x = transform.position.x + InputDeviceManager.GetAxis("Horizontal") * speedFactor;
			var y = transform.position.y + InputDeviceManager.GetAxis("Vertical") * speedFactor;
