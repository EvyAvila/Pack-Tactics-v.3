...
namespace PixelCrushers.LoveHate
{
    ...
    public class DeedTemplateLibraryEditor : UnityEditor.Editor
    {
        ...
        protected const int NumConcreteFields = 9;
        ...
        protected virtual void OnDrawDeedTemplateFieldListElement(Rect rect, int index, bool isActive, bool isFocused)
        {
            ...
            switch (index)
            {
                case 0:
                    ...
                    break;
                case 1:
                    DrawDeedTemplateField(labelRect, "No Repeat Duration", fieldRect, m_deedTemplate.FindPropertyRelative("noRepeatDuration"), false);
                    break;
                case 2:
                ...
                case 6:
                    ...
                    break;
                case 7:
                    var minAffinityEffectProp1 = m_deedTemplate.FindPropertyRelative("minAffinityEffect");
                    var maxAffinityEffectProp1 = m_deedTemplate.FindPropertyRelative("maxAffinityEffect");
                    if (minAffinityEffectProp1.floatValue == 0 && maxAffinityEffectProp1.floatValue == 0)
                    {
                        minAffinityEffectProp1.floatValue = -100;
                        maxAffinityEffectProp1.floatValue = 100;
                    }
                    DrawDeedTemplateField(labelRect, "Min Affinity Effect", fieldRect, minAffinityEffectProp1, true);
                    maxAffinityEffectProp1.floatValue = Mathf.Max(minAffinityEffectProp1.floatValue, maxAffinityEffectProp1.floatValue);
                    break;
                case 8:
                    var minAffinityEffectProp2 = m_deedTemplate.FindPropertyRelative("minAffinityEffect");
                    var maxAffinityEffectProp2 = m_deedTemplate.FindPropertyRelative("maxAffinityEffect");
                    if (minAffinityEffectProp2.floatValue == 0 && maxAffinityEffectProp2.floatValue == 0)
                    {
                        minAffinityEffectProp2.floatValue = -100;
                        maxAffinityEffectProp2.floatValue = 100;
                    }
                    DrawDeedTemplateField(labelRect, "Max Affinity Effect", fieldRect, maxAffinityEffectProp2, true);
                    minAffinityEffectProp2.floatValue = Mathf.Min(minAffinityEffectProp2.floatValue, maxAffinityEffectProp2.floatValue);
                    break;
                default:
